...
let angka = 1432545653;
let angkaFormatIDR = "Rp " + angka.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".");
...
console.log("Jumlah digit:", jumlahDigit); // Output: Jumlah digit: 6
...
console.log(input.replace(/aA/ig, '*'))